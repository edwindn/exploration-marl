"""
Implementation from https://github.com/InexperiencedMe/NaturalDreamer
The following components have been removed or modified:
"""
...
from modules import RecurrentModel, PriorNet, PosteriorNet, RewardModel, ContinueModel, EncoderConv, DecoderConv, Actor, Critic
...
class Dreamer:
    ...
    def environmentInteraction(self, env, numEpisodes, seed=None, evaluation=False, saveVideo=False, filename="videos/unnamedVideo", fps=30, macroBlockSize=16):
        ...
        for i in range(numEpisodes):
            ...
            currentScore, stepCount, terminated, truncated, frames = 0, 0, False, False, []
            while not (terminated or truncated):
                ...
                nextObservation, reward, terminated, truncated, info = env.step(actionNumpy)

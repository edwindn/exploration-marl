"""
Adapted from implict model in TD-MPC2
"""
...
class WorldModel(nn.Module):
	"""
	TD-MPC2 implicit world model architecture (encoder, dynamics, reward, termination only).
	...
	def __repr__(self):
		...
		modules = ['Encoder', 'Dynamics', 'Reward', 'Termination']
		for i, m in enumerate([self._encoder, self._dynamics, self._reward, self._termination]):
